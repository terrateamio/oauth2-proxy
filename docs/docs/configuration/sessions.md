...
The HTTP storage backend must implement the following REST API. For detailed information including data flow examples, implementation samples in multiple languages, and troubleshooting, see the [detailed API specification](https://github.com/oauth2-proxy/oauth2-proxy/blob/master/contrib/HTTP_SESSION_STORE_API_DETAILS.md).
